...
| G6 licensed AppServer | compile success/error + RPO/TDS/CP1252 evidence | PARTIAL — em 2026-09-13, o AppServer de laboratório `Protheus Lab Local` com TDS 2.1.3/P12 aprovou uma compilação positiva e rejeitou uma fixture de include inexistente com rollback. O registro saneado é `docs/qa/live-appserver-tds-homologation-2026-09-13.md`. Ainda faltam supervisor do PEA, cancelamento/timeout/RPO bloqueado, diagnóstico nativo, CP1252/LF não-ASCII, DBAccess e evidência vinculada ao commit/artefatos exatos. |
