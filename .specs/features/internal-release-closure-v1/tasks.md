...
| IRC-03 | Executar a bateria do candidato no commit limpo | todos os comandos internos terminam com sucesso | `npm run validate:release-candidate` | Pendente |
| IRC-04 | Registrar o resultado e manter o gate externo fechado | relatório tem SHA, comandos, resultado e bloqueios reais | `npm run publication:release-check` deve falhar somente por evidência externa incompleta | Pendente |
