# Full project quality review v1 — Tasks

| ID | Task | Status | Gate |
| --- | --- | --- | --- |
| QR-T1 | Map source, tests, release evidence and live blockers. | Complete | review report |
| QR-T2 | Add a failing MCP progress-transport regression. | Complete | targeted RED |
| QR-T3 | Make progress notifications best-effort and rerun MCP tests. | Complete | targeted GREEN |
| QR-T4 | Add a failing repository contract for native coverage thresholds. | Complete | targeted RED |
