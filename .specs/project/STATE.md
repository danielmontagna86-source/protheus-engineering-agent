...
**Current Work:** O último baseline público integralmente validado é `d033443f1c5dede967fa9c7eac6a904a4f7bc016`, após os PRs #42 e #43. O candidato funcional local avançou para `90b311512db7f44dfecb80710a5b6d123e59a3e7`: adicionou cancelamento/timeout limitado na ponte TDS e o adapter provider-neutral de banco no runtime/MCP. O VSIX exato SHA-256 `c3439e3...` passou TDS 2.1.4/AppServer 24.3.1.5 com compilação direta positiva/negativa, cancelamento prévio/em voo, timeout e AppServer indisponível. O teste indisponível revelou que o contrato público do TDS não prova sucesso; o PEA foi corrigido para `TDS_COMPILE_SUCCESS_UNPROVEN` em zero erros. O mesmo commit passou a matriz PostgreSQL real privada. O responsável atestou origem Portal TOTVS do RPO; `TOP_NO_LICENSE` continua estado comercial documentado, não falha funcional. A prévia pública `v0.3.9` permanece em `29993a8`; o candidato local ainda precisa da bateria integral, revisão, merge e gates humanos/externos. Stable/Marketplace permanecem `NO-GO`.
